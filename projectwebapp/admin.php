...
<script>
    ...
    <button onclick="editRecord(<?php echo $row['user_id']; ?>, 'users')">Edit</button>
    <button onclick="deleteRecord(<?php echo $row['user_id']; ?>, 'users')">Delete</button>

    function editRecord(id, table) {
    // Trigger an edit form or send AJAX request for editing
    ...
    fetch('your_php_file.php', {
        ...
        body: new URLSearchParams({
            ...
            'action': 'update',
            'table': table,
            // Add additional form data here as needed
        })
...
function deleteRecord(id, table) {
    fetch('your_php_file.php', {
        ...
        console.log(data); // For debugging
        // Handle success/failure, maybe refresh the table or remove row from DOM
    });
}
